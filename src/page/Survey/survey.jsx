                                ...
                                questions: [
                                    ...
                                    const Survey = () => {
                                        ...
                                        const handleAnswer = (questionIndex, value) => {
                                            setAnswers(prev => ({
                                                ...prev,
                                                [`q${questionIndex + page * questionsPerPage}`]: value
                                            }));
                                        };
                                    
                                        const allAnswered = () => {
                                            return questions[page].questions.every((_, index) => 
                                                answers.hasOwnProperty(`q${index + page * questionsPerPage}`)
                                            );
                                        };
                                    
                                        const handleNext = () => {
                                            if (allAnswered() && page < questions.length - 1) {
                                                setPage(page + 1);
                                            }
                                        };
                                                                ...
                                                                {q.choices.map((choice, i) => (
                                                                    <label key={i} className="choice">
                                                                        <input 
                                                                            ...
                                                                            checked={answers[`q${index + page * questionsPerPage}`] === choice}
                                                                        /> 
                                                                        {choice}
                                                                    </label>
                                                                ))}
